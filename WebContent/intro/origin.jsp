...
<div id="contents">
	<section class="page" id="page1">
		<div style="width:1400px;margin:15px auto">
			...
			<div class="jumbotron">
				<p>
					대전은 1970년대에 충남과 충북의 합동 개발을 통해 설립된 계획도시였습니다.<br> 
					 조선 시대에는 "한밭(한라산의 밭)"이라는 이름으로 농경지였습니다.
					 그러나 20세기 초반까지는 그렇게 큰 도시로는 발전하지 못했습니다.대전이 현대적인 도시로서의 모습을 갖추게 된 계기는 20세기 중반에 산업화와 함께 온
					 국가적인 도시 개발 정책에 따라 변모하게 되었습니다. 이 과정에서 대전 중심지의 개발이 중요한 부분을 차지했습니다.대전 중구는 정부기관, 금융기관, 
	...
	<section class="page" id="page1">
		<div style="width:1400px;margin:15px auto">
			...
			<figure class="map_data">
				<img src="${path0 }/images/geumcheon.png" alt="대전 중구 지도">
			</figure>	
		</div>
	</section>	
</div>
